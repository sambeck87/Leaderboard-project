...
**[Leaderboard]** is a project that will display the players names and scores of a game. This project will save and display the scores getted from an API.
...
- Go to this repo and copy the project link
        https://github.com/sambeck87/Leaderboard-project
- Open your terminal and clone the repo with this command "git clone https://github.com/sambeck87/Leaderboard-project.git"
